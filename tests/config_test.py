...
class ConfigTest(unittest.TestCase):
    ...
    def test_use_sudo_kubernetes_enabled_without_config_file(self, resolve_mock):
        from unittest.mock import MagicMock
        mock_answer = MagicMock()
        mock_answer.to_text.return_value = "test_fqdn"
        resolve_mock.return_value = [mock_answer]
        kubernetes_args = {
            "k8s_enabled": 'True',
