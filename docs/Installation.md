...
* if you want client-side encryption of the SSTables stored in S3 (see [Client-side encryption](client_side_encryption.md)), run `sudo pip3 install cassandra-medusa[S3,encryption]`
